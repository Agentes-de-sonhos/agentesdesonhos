---
id: despesas-mapa-onda-2
titulo: Despesas — Mapa de produção (Onda 2)
modulo: Despesas
...
# Despesas — Mapa de produção da Onda 2 (Subonda 2A)

## Status
**Concluído.** Todas as entregas da Subonda 2A foram produzidas, validadas e publicadas no RAG.

## Objetivo do módulo
Documentar de forma confiável a operação da aba **Financeiro → Despesas**: criação, edição, exclusão, status, recorrência (quando aplicável), exportação e relação com outros módulos do Financeiro.
