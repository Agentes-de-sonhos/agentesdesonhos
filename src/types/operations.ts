...
export const OPERATION_STAGES: { key: OperationStage; label: string; color: string; bg: string; border: string; text: string }[] = [
  { key: 'venda_confirmada', label: 'Venda Confirmada', color: 'bg-emerald-600', bg: 'bg-emerald-50 dark:bg-emerald-950/40', border: 'border-emerald-200 dark:border-emerald-800', text: 'text-emerald-700 dark:text-emerald-300' },
