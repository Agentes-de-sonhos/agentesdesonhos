...
export interface AgencyHeroPresentation {
  ...
  titleWeight?: "regular";
  /** Contraste reforçado à esquerda para fotos claras. */
  overlay?: "strongLeft";
}
...
const EDITORIAL_ROSE: AgencySiteProfile = {
  ...
  hero: [
    { title: "Sua viagem importa.\nCada detalhe também.", subtitle: "Consultoria completa e atendimento próximo para você viajar com tranquilidade, segurança\ne experiências que realmente combinam com você.", image: "heroVarenna", focalPoint: "varenna", order: 1, enabled: true },
    { title: "Orlando, Europa, cruzeiros e resorts\nplanejados por quem conhece", subtitle: "Destinos, hospedagens e experiências selecionados de acordo com o perfil, o momento e as prioridades de cada viajante.", image: "heroSantoriniShip", focalPoint: "santoriniShip", order: 2, enabled: true },
    { title: "Do primeiro planejamento ao retorno,\nvocê viaja com suporte de verdade", subtitle: "Um atendimento conduzido de perto, com orientação, organização e acompanhamento antes, durante e depois da viagem.", image: "heroAirportTraveler", focalPoint: "airportTraveler", textWidth: "narrowLeft", order: 3, enabled: true },
  ],
  requestCenter: {
  ...
  destinations: [
    ...
    { key: "cruzeiro-certo", image: "cruzeiroDisneyWish", label: "Experiência em alto-mar", title: "O cruzeiro certo para cada viajante", text: "Companhia, navio, itinerário e categoria de cabine escolhidos com orientação de quem conhece diferentes experiências de cruzeiro.", service: "cruzeiros", enabled: true, order: 3 },
    { key: "caribe-mexico", image: "caribeMexico", label: "Praias e experiências", title: "Caribe e México", text: "Mar, cultura, gastronomia e resorts selecionados para casais, famílias e grupos de amigos que procuram conforto e experiências especiais.", service: "pacotes", enabled: true, order: 4 },
    { key: "nordeste-conforto", image: "nordesteResort", label: "Resorts e all inclusive", title: "Nordeste com conforto e tranquilidade", text: "Resorts e experiências para famílias, casais e grupos que querem descansar com estrutura, segurança e facilidade.", service: "hospedagem", enabled: true, order: 5 },
  ],
  modules: [
