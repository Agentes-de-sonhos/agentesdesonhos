...
const EDITORIAL_ROSE: AgencySiteProfile = {
  ...
  hero: [
    ...
    { title: "Orlando, Europa, cruzeiros e resorts\nplanejados por quem conhece", subtitle: "Destinos, hospedagens e experiências selecionados de acordo com o perfil, o momento e as prioridades de cada viajante.", order: 2, enabled: true },
