...
const THEMES: DirectoryCategoryTheme[] = [
  {
    ...
    iconColor: "text-blue-600 dark:text-blue-400", logoRing: "ring-blue-200/60 dark:ring-blue-800/50",
  ...
  },
  {
    ...
    iconColor: "text-violet-600 dark:text-violet-400", logoRing: "ring-violet-200/60 dark:ring-violet-800/50",
  ...
  },
  {
    ...
    iconColor: "text-sky-600 dark:text-sky-400", logoRing: "ring-sky-200/60 dark:ring-sky-800/50",
  ...
  },
  {
    ...
    iconColor: "text-amber-600 dark:text-amber-400", logoRing: "ring-amber-200/60 dark:ring-amber-800/50",
  ...
  },
  {
    ...
    iconColor: "text-emerald-600 dark:text-emerald-400", logoRing: "ring-emerald-200/60 dark:ring-emerald-800/50",
  ...
  },
  {
    ...
    iconColor: "text-cyan-600 dark:text-cyan-400", logoRing: "ring-cyan-200/60 dark:ring-cyan-800/50",
  ...
  },
  {
    ...
    iconColor: "text-rose-600 dark:text-rose-400", logoRing: "ring-rose-200/60 dark:ring-rose-800/50",
  ...
  },
  {
    ...
    iconColor: "text-pink-600 dark:text-pink-400", logoRing: "ring-pink-200/60 dark:ring-pink-800/50",
  ...
  },
  {
    ...
    iconColor: "text-orange-600 dark:text-orange-400", logoRing: "ring-orange-200/60 dark:ring-orange-800/50",
  ...
  },
  {
    ...
    iconColor: "text-teal-600 dark:text-teal-400", logoRing: "ring-teal-200/60 dark:ring-teal-800/50",
...
const FALLBACK_THEME: DirectoryCategoryTheme = {
  ...
  iconColor: "text-muted-foreground", logoRing: "ring-border/50",
