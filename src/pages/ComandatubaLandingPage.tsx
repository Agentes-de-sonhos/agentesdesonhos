...
import { SEO_TEMPLATE, FORM_ANCHOR_ID, scrollToForm } from "@/components/landing/comandatuba/content";
...
export default function ComandatubaLandingPage() {
  useNoindex();
  const agency = useComandatubaAgency();
  ...
  return (
    <div className="min-h-screen scroll-smooth bg-white text-slate-900 [scroll-behavior:smooth]">
      ...
      <main>
        ...
        <QuoteFormSection agency={agency} formRef={formRef} />
        <FaqSection agency={agency} />
        <FinalCTASection agency={agency} />
        <div id={`${FORM_ANCHOR_ID}-end`} aria-hidden />
      </main>
      <Footer agency={agency} />
      <ConsultantWidget agency={agency} />
    </div>
  );
}