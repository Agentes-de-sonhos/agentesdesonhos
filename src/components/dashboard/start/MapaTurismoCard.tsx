    ...
    <Card className="border-0 shadow-card">
      <CardContent className="pt-5 pb-5 space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          ...
          <div className="flex items-center gap-2 sm:gap-3 sm:flex-shrink min-w-0">
            {/* Engagement teaser — inline com o título */}
            <div className="rounded-xl bg-primary/5 border border-primary/15 px-3 py-2 space-y-0.5 min-w-0">
