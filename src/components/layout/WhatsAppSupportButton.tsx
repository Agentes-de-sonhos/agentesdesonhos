  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 flex flex-col items-center gap-1">
      <a
        ...
        className="flex items-center gap-2 rounded-2xl bg-[#25D366] px-5 py-2.5 text-white shadow-lg shadow-[#25D366]/30 transition-all hover:scale-105 hover:shadow-xl hover:shadow-[#25D366]/40 animate-[pulse_3s_ease-in-out_infinite] sm:py-3 sm:px-6"
      >
