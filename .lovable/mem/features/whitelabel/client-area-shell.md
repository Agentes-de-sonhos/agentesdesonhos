...
- A Área do Cliente não exibe acesso por código de link, nem no login nem na página inicial autenticada; links públicos específicos continuam acessíveis diretamente por suas próprias URLs.
