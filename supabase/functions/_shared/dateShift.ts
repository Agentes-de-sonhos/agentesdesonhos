...
/**
 * Embarque sempre a 7 dias de hoje: a janela precisa permitir previsão do tempo
 * na Área do Cliente e ainda manter a viagem claramente próxima.
 */
export const START_OFFSET_DAYS = 7;
/** Retorno sempre a 14 dias de hoje (viagem de 8 dias / 7 noites). */
export const END_OFFSET_DAYS = 14;
