ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS agency_whatsapp_group_url text;

-- get_agency_domain: expõe o link do grupo para o template compartilhado
...
-- Allowlist: novo serviço de captação editorial
...
ALTER TABLE public.agency_site_requests
  ...
  CHECK (service_key IN ('aereo','hospedagem','carro','transfer','ingressos','seguro','cruzeiros','pacotes','inspiracoes'));
